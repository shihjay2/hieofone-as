	  ...
	  <!-- Modal content-->
		<div class="modal-content">
			...
			<div class="modal-footer">
				...
				<a href="https://dir.hieofone.org/doximity-start/" target="_blank" class="btn btn-default" id="doximity_modal"><i class="fa fa-btn fa-hand-o-right"></i> Get from Doximity</a>
