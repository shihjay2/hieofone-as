					...
					<form class="form-horizontal" role="form" method="POST" action="{{ URL::to('change_policy') }}">
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									<label><input type="checkbox" name="login_direct" {{ $login_direct }}> Anyone signed-in directly to this Authorization Server sees and controls Everything</label>
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									<label><input type="checkbox" name="public_publish_directory" {!! $public_publish_directory !!}> Anyone can see and link to your Trustee in a Directory</label>
						...
						<div class="form-group">
							<div class="col-sm-offset-2 col-sm-10">
								<div class="checkbox">
									<label><input type="checkbox" name="last_activity" {!! $last_activity !!}> Publish the most recent date and time when this Trustee was active to a Directory</label>
