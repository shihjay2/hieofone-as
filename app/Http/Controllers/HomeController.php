...
class HomeController extends Controller
{
    ...
    public function consent_table(Request $request)
    {
        ...
        if ($directories) {
            foreach ($directories as $directory1) {
                $data['content'] .= '<tr><td><div class="row"><div class="col-xs-9" style="display:inline-block;float:none;">' . $directory->name . '</div><div class="col-xs-3" style="display:inline-block;float:none;"><div style="display:inline-block;float:none;"><img src="' . asset('assets/UMA2-logo.png') . '" style="max-height: 40px;width: auto;"></img></div><div style="display:inline-block;float:none;"><a href="' . route('directory_remove', [$directory->id, true]) . '" data-toggle="tooltip" title="Remove from Directory"><i class="fa fa-btn fa-lg fa-times" style="margin:10px;"></i></a></div></div></div></td><td></td><td>Directory</td>' . $column_empty . '</tr>';
            }
        }
