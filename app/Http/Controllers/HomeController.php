                ...
                foreach ($smart_on_fhir as $smart_row) {
                    ...
                    if ($fhir_db) {
                        if ($fhir_db->username !== null && $fhir_db->username !== '') {
                            $copy_link .= '<span style="margin:10px"></span><i class="fa fa-clone fa-lg pnosh_copy" hie-val="' . $fhir_db->username . '"></i><span style="margin:10px"></span><i class="fa fa-key fa-lg pnosh_copy" hie-val="' . decrypt($fhir_db->password) . '"></i>';
                        }
                    } else {
                        $fhir_data = [
