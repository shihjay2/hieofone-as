    ...
    public function google(Request $request)
    {
        ...
        if ($google_user) {
            ...
            if (isset($bridgedResponse['access_token'])) {
                ...
                return redirect()->route('login')->withErrors(['tryagain' => 'Client ID:' . $client_id . '.  Response: ' . json_encode($bridgedResponse) . '.  Request: ' . json_encode($request) . '.  OAuth authentication failed.  Please contact the owner of this authorization server for assistance.']);
            }
        } else {
